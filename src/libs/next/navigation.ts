...
// ---------------------------------------------------------------------------
// useServerInsertedHTML — no-op in SPA (server-only concept)
// ---------------------------------------------------------------------------
export function useServerInsertedHTML(_cb: () => React.ReactNode): void {
  // no-op in SPA mode; styles should be injected via <style> in index.html
  // or via CSS-in-JS runtime (antd-style / emotion)
}
